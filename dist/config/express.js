...
if (typeof global.web3 !== 'undefined') {
  global.web3 = new _web2.default(global.web3.currentProvider);
} else {
...
var whitelist = ['http://explorer.51ddkan.com', 'http://healthimage.51ddkan.com', 'http://wallet.51ddkan.com', 'http://localhost:1234', 'http://192.168.3.221:3000', 'http://dh.life'];
var corsOptions = {
  credentials: true,
...
// const corsOptions = {
//   credentials: true,
//   origin: config.env === 'development' ? ['http://dhc.51ddkan.com', 'http://healthimage.51ddkan.com/'] : ['http://dhc.51ddkan.com', 'http://healthimage.51ddkan.com/'],
// };
